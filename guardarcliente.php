    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Bienvenid@!!!</h2>
          <p>&nbsp;</p>
          <h2><head><marquee bgcolor="black" behavior="alternate"><font size="5" color="white"><b>Registrado sastifactoriamente </b></font></marquee></h2>
          <div class="clr">
		  <?php
...
mysql_close($link);
echo '<center><img src="chulo.png" width="200" height="200" /></center>';
?></div>
          <div class="img"></div>
