...
if (isset($_GET['idclientes']))
{
	...
	echo '<center><table width="200" border="1" bgcolor="#967853">
<tr>
<th><font size="3" color="#282A2A" face="georgia">El cliente con el codigo <b>'.$idclientes.'<b> ha sido eliminado <img src="eliminar.png" width="70" height="70"/></font</th>
</tr>
<br>
<br>
<tr>
