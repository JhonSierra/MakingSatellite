...
<head>
	...
	<title>Making Satellite - Catálogo</title> <!--Titulo del sitio-->
...
<body>
	<header>
		...
		<table class="logbar"> <!--Menú de login-->
			<tr>
				<td align="right"><a href="login.php">Iniciar sesión</a> &nbsp;|&nbsp; <a href="registro.php">Registrarme</a></td>
			</tr>
		</table>
		<br>
	...
	<section>
		<span class="barra"> <!--Menú de ropa-->
			<ul>
				...
				<li><a href="busos.php">Busos</a></li>
				<li><a href="pantalones.php">Pantalones</a></li>
				<li><a href="pantalonetas.php">Pantalonetas</a></li>
			</ul>
		</span>

		<table class="table"> <!--Tabla de productos-->
			<tr>
				<td><img src="../pictures/productos/camiseta.png"><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src="../pictures/productos/chaqueta.png"><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src="../pictures/productos/jean.png"><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src="../pictures/productos/pantaloneta.png"><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
			</tr>
			<tr>
				<td><img src=""><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src=""><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src=""><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
				<td><img src=""><br><button type=""><span class="icon icon-shopping-cart"></span>Comprar</button></td>
			</tr>
	...
	<footer> <!--Pie de página-->
		...
		<div class="admin">
		<a href="login-administrador.php" title="Ingresar como administrador">Administración</a></div> <!--Login de administrador-->
