...
$primerapellido = $_GET['primerapellidos'];
...
$sql = "UPDATE clientes SET nombre='$nombre', primerapellido='$primerapellido',segundopellido='$segundoapellido',documentoidentidad='$documentoidentidad',fechanacimiento='$fechanacimiento',direccion='$direccion',correo='$correo',telefonos='$telefonos' WHERE idclientes=$idclientes";
...
echo '<table width="200" border="1" bgcolor="">
<tr>
<th><font size="2" color="#282A2A" face="Georgia">El cliente con el Id <b>'.$idclientes.'</b> ha sido actualizado con éxito.<br><img src="modificar.png" width="70" height="70"/></th>
</tr>';
...
<table width="200" border="1" bgcolor="">
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Id:</font></td>
    <td>' . $idclientes . '</td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Nombre:</font></td>
    <td><input type="text" value="'.$nombre.'" name="nombre" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Primer Apellido:</font></td>
    <td><input type="text" value="'.$primerapellido.'" name="primerapellido" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Segundo Apellido:</font></td>
    <td><input type="text" value="'.$segundoapellido.'" name="segundoapellido" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Documento de Identidad:</font></td>
    <td><input type="text" value="'.$documentoidentidad.'" name="documentoidentidad" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Fecha de Nacimiento:</font></td>
    <td><input type="text" value="'.$fechanacimiento.'" name="fechanacimiento" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Direccion:</font></td>
    <td><input type="text" value="'.$direccion.'" name="direccion" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Correo:</font></td>
    <td><input type="text" value="'.$correo.'" name="correo" /></td>
  </tr>
  <tr>
    <td><font size="3" color="#282A2A" face="Georgia">Telefonos:</font></td>
    <td><input type="text" value="'.$telefonos.'" name="telefonos" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" value="Modificar" name="actualizar" /></td>
  </tr>
</table>
</form>';
