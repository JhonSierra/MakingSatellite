...
<body>
	...
	<section>
		<article> <!--Información de la empresa-->
			<br><center><img src="pictures/making/Icon-registro.png" width="314" height="283"><h2>Hemos Registrado tus datos.</h2>
	...
	<footer> <!--Pie de página-->
		...
		<div class="admin">
		<a href="admin/index.php.php" title="Ingresar como administrador">Administración</a></div> <!--Login de administrador-->
