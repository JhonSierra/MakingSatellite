...
<div class="container">
  ...
  <!-- end .sidebar1 --> </div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="Titulo" -->Cerrando sesion<!-- InstanceEndEditable --></h1>
    <p><!-- InstanceBeginEditable name="Contenido" -->Muchas Gracias por comprar<!-- InstanceEndEditable --><!-- end .content --></p>
