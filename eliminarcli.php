...
<th><font size="2" color="#4F8DBD" face="Georgia">Acciones</font></th>
</tr>';
...
while($filas=mysql_fetch_array($resultado))
{
	...
	<td><a href='eliminarcliente.php?idcliente=$filas[0]&nombre=$filas[1]&primerapellido=$filas[2]&segundoapellido=$filas[3]&documentoidentidad=$filas[4]&fechanacimiento=$filas[5]&direccion=$filas[6]&correo=$filas[7]&telefonos=$filas[8]'>Eliminar</a></td>
	</tr>";	
}
echo "</table></center>";
?></div>
