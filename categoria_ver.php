...
<div class="container">
  ...
  <!-- end .sidebar1 --> </div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="Titulo" --><center>Productos</center><!-- InstanceEndEditable --></h1>
    ...
    <?php do { ?>
    <div class="producto"><div class="fotoproducto"><img src="documentos/productos/<?php echo $row_DatosProductos['strImagen']; ?>" width="120" height="120" /></div><div class="textoproducto">
