...
echo '<center><table width="200" border="1" bgcolor="">
<tr>
<th><font size="2" color="#282A2A" face="Georgia">Id</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Nombre</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Primer Apellido</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Segundo Apellido</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Documento de Identidad</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Fecha de Nacimiento</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Direccion</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Correo</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Telefonos</font></th>
<th><font size="2" color="#282A2A" face="Georgia">Acciones</font></th>
</tr>';
...
while($filas=mysql_fetch_array($resultado))
{
	...
	<td><a href='modificarcliente.php?idclientes=$filas[0]&nombre=$filas[1]&primerapellido=$filas[2]&segundoapellido=$filas[3]&documentoidentidad=$filas[4]&fechanacimiento=$filas[5]&direccion=$filas[6]&Correo=$filas[7]&telefonos=$filas[8]'>Modificar</a></td>
	</tr>";	
}
echo "</table></center>";
?></div>
