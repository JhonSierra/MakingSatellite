...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Making Satellite</span><small>Crea Tu Moda</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Contact</span>o</h2>
          <div class="clr"></div>
          <p>Aqui podras dejar tus dudas e inquietudes, no dudes en escribirnos nosotros te responderemos y te ayudaremos a darle solucion<br />
            <br />
GRACIAS!!!</p>
        </div>
        <div class="article">
          <div class="clr"></div><div class="col c3">
        <p>&nbsp;</p>
        ...
        <div class="article">
          <h2><span>Deja un comentario</span></h2>
          <div class="clr"></div>
          <form action="#" method="post" id="sendemail">
            <ol>
              <li>
                <label for="name">Nombre (necesario)</label>
                <input id="name" name="name" class="text" />
              </li>
              <li>
                <label for="email">Correo Electronico (necesario)</label>
              ...
              <li>
                <input type="image" name="imageField" id="imageField" src="images/submit.png" class="send" />
                <div class="clr"></div>
              </li>
            </ol>
          </form>
...
<div align=center>Gmail  <a href='http://all-free-download.com/free-website-templates/'>jfsierra81@misena.edu.com</a></div></body>
</html>
